...
beautiful.menu_font="cantarell bold 15"
beautiful.menu_bg_normal="#343a40"
beautiful.menu_fg_normal="#ffffff"
beautiful.menu_fg_focus="#343a40"
beautiful.menu_bg_focus="#ffffff"
--beautiful.menu_fg_focus="";

mymainmenu = awful.menu({ items = { { "🏛️ Awesome", myawesomemenu },
                                    { "🧭 Browser", browser },
                                    { "🖿  Explorer", files },
                                    { "⌨️ Terminal", terminal },
...
os.execute("xrandr -s 1920x1080")
os.execute("xrandr --dpi 96")
awful.spawn.with_shell("feh --bg-fill ~/Pictures/background.jpg")
